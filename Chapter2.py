...
def talk_to_villagers(player):
    ...
    time.sleep(3)
    print("They tell you about dragon lord coming through, destroying everything in its path, "
...
def run(player):
    ...
    time.sleep(2)
    print("You see that the majority of the village was destroyed, there are survivors.")
